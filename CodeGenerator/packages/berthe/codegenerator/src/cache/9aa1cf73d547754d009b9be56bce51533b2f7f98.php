<?php $__env->startSection('title'); ?>
	<?php echo e(ucfirst($table['title'])); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
	<form action="/<?php echo e($table['title']); ?>" method="post">
	<?php if( array_key_exists('attributs', $table) ): ?>
				<?php $__currentLoopData = $table['attributs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attrName => $attrType): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
					...
					<?php if(gettype($attrType) == gettype(0)): ?>
						<div class="form-group">
							<label id="<?php echo e($attrName); ?>"><?php echo e(ucfirst($attrName)); ?></label>
	...
	<?php if(array_key_exists('relations', $table)): ?>
		<?php $__currentLoopData = $table['relations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationType => $tab): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
